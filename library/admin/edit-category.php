...
<head>
    ...
    <title>Online Library | Edit Categories</title>
...
<input class="form-control" type="text" name="category" value="<?php echo htmlentities($result->CategoryName);?>" required  pattern = "^[A-Za-z]+[A-Za-z ]*$" />
</div>
<div class="form-group">
<label>Status</label>
