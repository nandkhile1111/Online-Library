...
$bookid=$_POST['bookid'];
$ExpectedReturnDate	=strtoupper($_POST['ExpectedReturnDate']);
$isissued=1;
$sql="INSERT INTO  tblissuedbookdetails(StudentID,BookId,ExpectedReturnDate) VALUES(:studentid,:bookid,:ExpectedReturnDate);
update tblbooks set isIssued=:isissued where id=:bookid;
update tblissuedbookdetails set ExpectedReturnDate=:ExpectedReturnDate where BookId=:bookid";
...
<head>
    ...
    <title>Online Library | Issue a new Book</title>
...
<label for="date">Excepted Return Date:</label>
