...
$sql="INSERT INTO  tblbooks(BookName,CatId,AuthorId,ISBNNumber,BookPrice,bookImage,Rowloc,Colloc) VALUES(:bookname,:category,:author,:isbn,:price,:imgnewname,:rowloc,:colloc)";
...
$query->bindParam(':rowloc',$rowloc,PDO::PARAM_STR);
$query->bindParam(':colloc',$colloc,PDO::PARAM_STR);
$query->execute();
...
<div class="col-md-6">  
 <div class="form-group">
 <label>Row Location<span style="color:red;">*</span></label>
 <input class="form-control" type="number" name="rowloc" autocomplete="off"   required="required" />
 </div>
</div>

<div class="col-md-6">  
 <div class="form-group">
 <label>Column Location<span style="color:red;">*</span></label>
 <input class="form-control" type="number" name="colloc" autocomplete="off"   required="required" />
 </div>
</div>
