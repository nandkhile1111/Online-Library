...
<head>
    ...
    <title>Online Library | Issued Book Details</title>
...
<?php 
$rid=intval($_GET['rid']);
$sql = "SELECT tblstudents.StudentId ,tblstudents.FullName,tblstudents.EmailId,tblstudents.MobileNumber,tblbooks.BookName,tblbooks.ISBNNumber,tblissuedbookdetails.IssuesDate,tblissuedbookdetails.ExpectedReturnDate,tblissuedbookdetails.ReturnDate,tblissuedbookdetails.id as rid,tblissuedbookdetails.fine,tblissuedbookdetails.RetrunStatus,tblbooks.id as bid,tblbooks.bookImage from  tblissuedbookdetails join tblstudents on tblstudents.StudentId=tblissuedbookdetails.StudentId join tblbooks on tblbooks.id=tblissuedbookdetails.BookId where tblissuedbookdetails.id=:rid";
$query = $dbh -> prepare($sql);
$query->bindParam(':rid',$rid,PDO::PARAM_STR);
$query->execute();
...
<div class="col-md-6"> 
<div class="form-group">
<label>Excepted Return Date :</label>
...
echo "<input type='text' name='fine' value='$fineAmount' readonly>";

//$fineAmountEscaped = mysqli_real_escape_string($conn, $fineAmount);

$sql = "UPDATE tblissuedbookdetails SET FineAmount = $fineAmountEscaped WHERE ISBNNumber = $ISBNNumber";
