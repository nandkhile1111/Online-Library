...
if(!empty($_POST["bookid"])) {
  $bookid=$_POST["bookid"];
    ...
    $sql ="SELECT distinct tblbooks.BookName,tblbooks.rowloc,tblbooks.colloc,tblbooks.id,tblauthors.AuthorName,tblbooks.bookImage,tblbooks.isIssued FROM tblbooks
...
<img src="bookimg/<?php echo htmlentities($result->bookImage); ?>" width="120"><br />
	...
	Book is Located on : Row
	 <?php echo htmlentities($result->rowloc); ?>
	 and Column
	  <?php echo htmlentities($result->colloc); ?><br/>
